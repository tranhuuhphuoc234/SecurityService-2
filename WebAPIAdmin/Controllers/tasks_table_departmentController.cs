...
namespace WebAPIAdmin.Controllers
{
    ...
    [ApiController]
    public class tasks_table_departmentController : ControllerBase
    {
        private readonly Security_ServiceContext _context;

        public tasks_table_departmentController(Security_ServiceContext context)
        {
            _context = context;
        }
        [HttpGet("{id_department}")]
        public async Task<ActionResult<List<Models.View.taskView>>> Getaskdepartment(int id_department)
        {
